    ...
    <div className="pt-16 min-h-screen">
      ...
      <div className="bg-gradient-to-br from-navy-900 via-navy-800 to-navy-700 pt-16 pb-12">
        <div className="container-wrap section-x">
          ...
          <h1 className="hero-anim hero-d1 text-2xl md:text-3xl font-extrabold text-white mb-3">커리큘럼</h1>
          <p className="hero-anim hero-d2 text-white/60">AI 역량 개발을 위한 단계별 학습 로드맵입니다.</p>
        </div>
      </div>
